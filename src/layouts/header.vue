<template>
  <div class="header">
   ...
   <div class="movie_menu">
   	<div class="city_name">
		<router-link to="/city">
   		<span>上海</span><i class="iconfont icon-lower-triangle"></i></router-link>
   	</div>
   	<div class="hot_swtich">
   		<!-- <div class="hot_item active">正在热映</div> -->
		<!-- <div class="hot_item">即将上映</div> -->
		<router-link class="hot_item" to="/home" tag="div" active-class="active"><a href="javascript:;" >热映</a></router-link>
		<router-link class="hot_item" to="/coming" tag="div" active-class="active"><a href="javascript:;" >待映</a></router-link>
   	</div>
...
<style scoped>
  ...
  .movie_menu .city_name{ margin-left: 20px; height:100%; line-height: 45px;display: inline;}
  ...
  .movie_menu .search_entry.active a{ color: #ef4238; border-bottom: 2px #ef4238 solid;}
